          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent ${errors.storeId ? 'border-red-300' : 'border-gray-300'
                  }`}
              >
                <option value="">Select Store</option>
                {stores && stores.map((store) => (
                  <option key={store.name} value={store._id}>
                    {store.name}
                  </option>
                ))}
              </select>
